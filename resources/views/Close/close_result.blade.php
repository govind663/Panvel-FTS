    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <hr>
                <form method="GET" action="{{ url('Closefilesearch') }}" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="pd-20 card-box mb-30">
                        ...
                        <div class="row p-2">
                            <div class="col-lg-12">
                                ...
                                <hr>
                                @if ($file_type->status != '14')
                                    @if($forward->isNotEmpty()  && ($file_type->current_user_id == Auth::user()->id || $file_type->inserted_by == Auth::user()->id) )
                                        <form method="post" action="{{ url('close_result') }}" class="form-horizontal"
                                    enctype="multipart/form-data">
                                    {{ csrf_field() }}

                                    <input type="hidden" name="inserted_by" id="inserted_by" class="form-control "
                                        value="{{ Auth::user()->id }}">
                                    <input type="hidden" name="user_login" id="user_login" class="form-control "
                                        value="{{ Auth::user()->name }}">
                                    <input type="hidden" name="dept_login" id="dept_login" class="form-control "
                                        value="{{ Auth::user()->department }}">
                                    <input type="hidden" name="tableno_login" id="tableno_login" class="form-control "
                                        value="{{ Auth::user()->table_no }}">
                                    ...
                                    <div class="form-group row mt-3">
                                        <label class="col-sm-2 pt-2"><strong>Close File Status &nbsp;&nbsp; : &nbsp;&nbsp;<span class="text-danger">*</span></strong></label>
                                        <div class="col-sm-4 col-md-4">
                                            <select class="custom-select2 form-control @error('file_status') is-invalid @enderror" name="file_status" id="file_status">
                                                ...
                                                <optgroup label="">
                                                    <option value="14">Closed / निकाली</option>
                                                </optgroup>
                                            </select>
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input type="text" name="tipani_page" id="tipani_page"
                                                class="form-control  @error('tipani_page') is-invalid @enderror" value=""
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input type="file" name="pdf" id="pdf"
                                                class="form-control  @error('pdf') is-invalid @enderror" value="">
                                            @if ($errors->has('pdf'))
                                                <span class="err">
                                        ...
                                        <label class="col-sm-2 pt-2"><strong>Method&nbsp;&nbsp; : &nbsp;&nbsp;<span
                                    ...
                                    @else
                                        <p>Either You Have Already Closed The File OR You Don't Have Access To This File.</p>
                                    @endif
                                @else
                ...
                <div class="card-box pd-20 height-100-p mb-30">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="col-md-9">
                                <!--<a href="{{ url('department') }}" class="btn btn-danger">Cancel</a>&nbsp;&nbsp;-->
                                <a class="btn btn-success" href="{{ url('close_result') }}">Back To Home</a>
                            </div>
                        </div>
                    </div>
                </div>
