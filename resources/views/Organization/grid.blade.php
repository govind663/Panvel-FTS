    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item "><a >organization</a></li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-md-6 col-sm-12 text-right">
                        <a class="btn btn-primary" href="{{ route('organization.create') }}" role="button">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">Organization Master List</h4>
                </div>
                <div class="pb-20">
                        ...
                        <tbody>
                            @foreach ($data as $key => $file_type)
                                <tr>
                                    ...
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="{{ $path.$file_type->logo }}" class="img-thumbnail" style="border-radius: 50%;" width="80" height="80" alt="{{ $file_type->name }}"></td>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{ route('organization.edit', $file_type->id) }}" class="btn btn-info btn-sm">
                                            <i class="micon dw dw-pencil-1"></i>
                                        </a>
                                    </td>

                                    <td>
                                        <form action="{{ route('organization.destroy', $file_type->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
