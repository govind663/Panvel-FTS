...
<head>
    ...
    <!-- Site favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ url('/') }}/assets/vendors/images/png 20 x 20-01-01 (1).png">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ url('/') }}/assets/vendors/images/png 20 x 20-01-01 (1).png">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('/') }}/assets/vendors/images/png 20 x 20-01-01 (1).png">
		...
		<div class="pd-10">
			<div class="error-page-wrap text-center">
				...
				<div class="pt-20 mx-auto max-width-200">
					<a href="{{ url('index') }}" class="btn btn-primary btn-block btn-lg">Back To Home</a>
				</div>
			</div>
		</div>
	</div>
