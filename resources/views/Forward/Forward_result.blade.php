    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <hr>
                <form method="GET" action="{{ url('Forwardsearch') }}" class="form-horizontal"
                            ...
                            <div class="col-lg-12">
                                ...
                                @if ($file_type->status != '14' && $file_type->current_user_id == Auth::user()->id )
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <select class="custom-select2 form-control @error('department_name') is-invalid @enderror" name="department_name" id="department_name">
                                                <option value=" ">&nbsp;&nbsp;Please Select Department</option>
                                                <optgroup label="Department">
                                                    @foreach ($department_name as $key => $comps)
                                                        <option value="{{ $key }}" {{ old('department_name') == "$key" ? 'selected' : '' }}>{{ $comps }}</option>
                                                    @endforeach
                                                </optgroup>
                                            </select>
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <select class="custom-select2 form-control @error('file_status') is-invalid @enderror" name="file_status" id="file_status">
                                                <option value="Forward File Status">&nbsp;&nbsp;Please Select File Status</option>
                                                <optgroup label="">
                                                    <option value="12" selected>In Transit</option>
                                                </optgroup>
                                            </select>
                                    ...
                                    @else
                                        <p>The File Is Not Created By You; OR It Seems Either You Have Not Accepted The File</p>
                                    @endif
                                @else
                                    @if ($file_type->status == '14')
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group row mt-4">
                                <div class="col-md-9">
                                    <!--<a href="{{ url('department') }}" class="btn btn-danger">Cancel</a>&nbsp;&nbsp;-->
                                    <a class="btn btn-success" href="{{ url('Forward') }}" >Back To Home</a>
                                </div>
                            </div>
                        </div>
                    </div>
